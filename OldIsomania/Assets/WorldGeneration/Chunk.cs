...
public class Chunk : MonoBehaviour
{
    ...
    public IEnumerator LoadChunk(WorldGenerationSettings worldGenerationSetting)
    {
        ...
        */
        ...
        Bounds meshBounds = new Bounds(Vector3.up * boundsCenterOffset, new Vector3(ChunkSettings.meshSize.x, boundsHeight, ChunkSettings.meshSize.y));
        ...
        */
        ...
        //yield return StartCoroutine(spawnPrefabs.Spawn(new WaitForFixedUpdate(), noiseLayerSettings.spawnPrefabs, noiseLayerSettings.objectDensity, groundMeshConst.meshSize));

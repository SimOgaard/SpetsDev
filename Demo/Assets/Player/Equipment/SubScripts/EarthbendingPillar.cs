...
public class EarthbendingPillar : MonoBehaviour
{
    ...
    private Vector3 ground_point;       // position you should move twords in the beginning, then sleep for some time.
    private Vector3 under_ground_point; // position you should spawn object in and move twords in the end then delete.
    ...
    {
        if (Physics.Raycast(point + new Vector3(0f, 15f, 0f), Vector3.down, out hit_data, 40f, layer_mask))
        {

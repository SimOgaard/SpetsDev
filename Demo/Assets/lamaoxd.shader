    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float orthoEyeDepth = lerp(_ProjectionParams.y, _ProjectionParams.z, orthoLinearDepth); // depth in units to ground
				float orthoPlainLinearDepth = 1 - i.screenPosition.z;
				float orthoPlainDepth = lerp(_ProjectionParams.y, _ProjectionParams.z, orthoPlainLinearDepth); // depth in units to water plain
				float depthDifference = orthoEyeDepth - orthoPlainDepth;
				//return distanceThroughWater;
				...
				//return float4(0, 221.0/255.0, 127.0/225.0, 1);

...
public static class Ground
{
    ...
    public static class CPUData
    {
        ...
        public static void Update(WorldGenerationSettings worldGenerationSettings)
        {
            ...
            verticeCountWidth = worldGenerationSettings.chunkSettings.quadAmount.x + 1;
            verticeCountHeight = worldGenerationSettings.chunkSettings.quadAmount.y + 1;
            verticeCount = verticeCountWidth * verticeCountHeight;

            verticeCountWidthExtended = worldGenerationSettings.chunkSettings.quadAmount.x + 1 + 2;
            verticeCountHeightExtended = worldGenerationSettings.chunkSettings.quadAmount.y + 1 + 2;
            verticeCountExtended = verticeCountWidthExtended * verticeCountHeightExtended;

            quadCountWidth = worldGenerationSettings.chunkSettings.quadAmount.x;
            quadCountHeight = worldGenerationSettings.chunkSettings.quadAmount.y;
            quadCount = quadCountWidth * quadCountHeight;

            quadCountWidthExtended = worldGenerationSettings.chunkSettings.quadAmount.x + 2;
            quadCountHeightExtended = worldGenerationSettings.chunkSettings.quadAmount.y + 2;
